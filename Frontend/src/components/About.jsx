        ...
        <motion.div className='flex mt-10 flex-col w-full justify-center items-center'
         ...
         initial="hidden"
          ...
          viewport={{ once:false,amount:0.5 }}>
            <span className='lg:text-7xl md:text-5xl xs:text-3xl text-white text-center Amoriafont tracking-wider'>Welcome To</span>
            <img src={sketchline1} alt="" className='flex lg:w-[30rem] md:w-[20rem] xs:w-[10rem] relative ' />
        </motion.div>
        <div className='w-full flex xs:flex-col flex-1 justify-center items-center gap-10 xs:gap-20 px-10'>
            ...
            <div className='flex xs:flex-col lg:gap-20 md:gap-14 xs:gap-10'>
            <motion.div className='flex flex-col border border-white p-2 navfonts tracking-wide'
            ...
            <motion.div className='flex flex-col border border-white p-2 md:relative md:bottom-7 navfonts tracking-wide'
              variants={fadeanimationforstats}
              initial="hidden"
              whileInView="visible"
              custom={2}
            ...
            <motion.div className='flex md:w-1/2 justify-center items-center'
